...
var doc = app.documents.getByName("light_map.psd");
...
function parseResults() {
    ...
    function wrapper() {
        ...
        w.close();
        updateGraphic(bidenTotal, trumpTotal);
    }
}
...
function updateGraphic(biden, trump) {
    ...
    function wrapper() {
        ...
        var bidenNum = otherDoc.artLayers.getByName("BIDEN NUMBER").textItem;
        var trumpBar = otherDoc.artLayers.getByName("TRUMP BAR").textItem;
        var bidenBar = otherDoc.artLayers.getByName("BIDEN BAR").textItem;
        var newTrumpNum = trump
        var newBidenNum = biden
